...
- (void)setText:(NSString *)text {
    [self setText:text refreshLabels:YES];
}
...
- (void)setAttributedText:(NSAttributedString *)text {
    [self setAttributedText:text refreshLabels:YES];
}

- (void)setAttributedText:(NSAttributedString *)text refreshLabels:(BOOL)refresh {
    if ([text.string isEqualToString:self.attributedText.string])
        return;

    EACH_LABEL(attributedText, text)
